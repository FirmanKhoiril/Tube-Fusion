  ...
  return (
    <div className="w-full flex flex-col justify-between gap-3">
      <div className="flex items-center justify-between gap-3 pr-2 w-full">
        ...
        <select
          className=" absolute top-0  opacity-0 h-full w-full text-black  bg-secondary-0/5  text-center  appearance-none cursor-pointer  focus:ring-2 focus:ring-[#10b981] focus:outline-none"
          onChange={(e) => {
