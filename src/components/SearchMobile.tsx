...
const SearchMobile = () => {
    ...
    const {searchBarMobileRef, setExpandSearchBarMobile, expandSearchBarMobile} = useHandleEventSearchMobile()
    ...
    <AnimatePresence>
        {expandSearchBarMobile && (
                ...
                onSubmit={handleSubmitSearching}
                    ...
                    className="fixed z-50 flex sm:hidden max-h-[75.5px] h-full items-center justify-between left-2 top-0 transform -translate-x-1/2 mt-2 w-[96.6%]  rounded-full   bg-dark-0 origin-center"
                >
